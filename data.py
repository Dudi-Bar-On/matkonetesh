...
CUTS = [
 ...
 dict(n=16,cat="מעורב",heb="נקניקיות",eng="Sausages",kg=1.0,svt=65,svh="1-2",smt=90,smh="0.75",tgt=71,safe=71,sear="לא",mid="ייבוש",wrap="לא",rest=5,rub="ללא (מתובל מראש)",wood="פקאן/תפוח",coal="Weber Lump",diff=1,sot=100,soh="2.5",somid="הפיכה",saved=1.8),
 ...
 dict(n=125,cat="פירות ים",heb="סטייק טונה",eng="Tuna Steak",kg=0.4,svt=45,svh="0.5",smt=250,smh="0.05",tgt=45,safe=63,sear="צריבה MR",mid="אין",wrap="לא",rest=1,rub="שומשום+סויה+ג'ינג'ר",wood="תפוח/אלון",coal="Weber Lump",diff=2,sot=250,soh="0.05",somid="סושי-גרייד; מרכז נא, 1-2 דק'/צד",saved=0.34,doneness={'default': 'med', 'scale': 'fish', 'levels': {'mr': {'c': 42}, 'med': {'c': 48}, 'well': {'c': 54}}}),
 dict(n=126,cat="פירות ים",heb="דג חרב",eng="Swordfish Steak",kg=0.5,svt=54,svh="0.75",smt=230,smh="0.1",tgt=60,safe=63,sear="גריל ישיר",mid="אין",wrap="לא",rest=2,rub="שמן זית+לימון+אורגנו",wood="תפוח/אלון",coal="Weber Lump",diff=2,sot=230,soh="0.1",somid="סטייק מוצק, קרוסהאץ'",saved=0.42,doneness={'default': 'med', 'scale': 'fish', 'levels': {'mr': {'c': 52}, 'med': {'c': 58}, 'well': {'c': 64}}}),
