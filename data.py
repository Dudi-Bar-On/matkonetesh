...
CUTS = [
 ...
 dict(n=16,cat="נקניקיות",heb="נקניקיות",eng="Sausages",kg=1.0,svt=65,svh="1-2",smt=90,smh="0.75",tgt=71,safe=71,sear="לא",mid="ייבוש",wrap="לא",rest=5,rub="ללא (מתובל מראש)",wood="פקאן/תפוח",coal="Weber Lump",diff=1,sot=100,soh="2.5",somid="הפיכה",saved=1.8),
