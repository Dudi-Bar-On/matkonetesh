...
CUTS = [
 dict(n=1,cat="בקר",heb="בריסקט",eng="Brisket",kg=5.5,svt=68,svh="30",smt=105,smh="3",tgt=94,safe=63,sear="לא",mid="צינון מלא",wrap="לא",rest=60,rub="מלח+פלפל גס (טקסני)",wood="אלון/היקורי",coal="Fogo Super Premium",diff=5,sot=110,soh="12",somid="עטיפה ב-70°C",saved=9.0),
 ...
 dict(n=7,cat="חזיר",heb="ספייריבס",eng="Pork Ribs",kg=1.5,svt=74,svh="24",smt=110,smh="2",tgt=95,safe=63,sear="לא",mid="גלייז",wrap="לא",rest=15,rub="ראב מתוק + פפריקה",wood="היקורי/תפוח",coal="Weber Lump",diff=3,sot=115,soh="5",somid="שיטת 3-2-1",saved=3.0),
 ...
 dict(n=9,cat="אווז",heb="חזה אווז",eng="Duck Breast",kg=0.4,svt=63,svh="3",smt=105,smh="0.75",tgt=65,safe=74,sear="כן",mid="ייבוש",wrap="לא",rest=8,rub="תפוז+פלפל+מלח",wood="דובדבן נקי",coal="Kamado Joe",diff=3,sot=110,soh="1.5",somid="הפיכה",saved=0.8),
 ...
 dict(n=11,cat="בקר",heb="טומאהוק",eng="Tomahawk",kg=1.2,svt=54,svh="2",smt=100,smh="0.75",tgt=54,safe=63,sear="כן",mid="צינון",wrap="לא",rest=15,rub="מלח+פלפל גס",wood="היקורי/אלון",coal="Kamado Joe",diff=3,sot=110,soh="2",somid="אין",saved=1.3),
 dict(n=12,cat="בקר",heb="פסטרמה בקר",eng="Beef Pastrami",kg=2.5,svt=65,svh="12",smt=105,smh="2",tgt=72,safe=63,sear="לא",mid="אין",wrap="לא",rest=30,rub="כבישה + ציפוי כוסברה+פלפל",wood="היקורי/אלון",coal="Fogo Premium",diff=4,sot=110,soh="5",somid="אין",saved=3.0),
 dict(n=13,cat="חזיר",heb="כתף חזיר",eng="Pork Shoulder",kg=4.0,svt=74,svh="24",smt=110,smh="2",tgt=98,safe=63,sear="לא",mid="מריחה",wrap="לא",rest=45,rub="ראב מתוק (פולד פורק)",wood="היקורי/תפוח",coal="Fogo Super Premium",diff=3,sot=105,soh="12",somid="עטיפה ב-70°C",saved=10.0),
 ...
 dict(n=16,cat="מעורב",heb="נקניקיות",eng="Sausages",kg=1.0,svt=65,svh="1-2",smt=90,smh="0.75",tgt=70,safe=71,sear="לא",mid="ייבוש",wrap="לא",rest=5,rub="ללא (מתובל מראש)",wood="פקאן/תפוח",coal="Weber Lump",diff=1,sot=100,soh="2.5",somid="הפיכה",saved=1.8),
 dict(n=17,cat="בקר",heb="קבב",eng="Kebab",kg=1.0,svt=55,svh="1",smt=105,smh="0.33",tgt=65,safe=71,sear="כן",mid="אין",wrap="לא",rest=5,rub="תיבול קבב (בצל+פטרוזיליה)",wood="אלון בלבד",coal="Fogo Premium",diff=2,sot=120,soh="0.67",somid="אין",saved=0.3),
 dict(n=18,cat="בקר",heb="המבורגר",eng="Hamburger",kg=0.2,svt=55,svh="1.5",smt=85,smh="0.25",tgt=55,safe=71,sear="כן",mid="ייבוש",wrap="לא",rest=5,rub="מלח+פלפל",wood="אלון/היקורי",coal="Weber Lump",diff=1,sot=120,soh="0.67",somid="אין",saved=0.4),
 ...
 dict(n=21,cat="בקר",heb="צלעות בקר (דינו)",eng="Beef Back Ribs",kg=2.5,svt=68,svh="24",smt=110,smh="3",tgt=94,safe=63,sear="לא",mid="אין",wrap="לא",rest=30,rub="ראב בקר קלאסי",wood="היקורי/אלון",coal="Fogo Super Premium",diff=3,sot=110,soh="6.5",somid="עטיפה ב-75°C",saved=3.5),
 dict(n=22,cat="בקר",heb="לשון בקר",eng="Beef Tongue",kg=1.2,svt=70,svh="24-48",smt=105,smh="2",tgt=90,safe=63,sear="לא",mid="קילוף קרום",wrap="לא",rest=20,rub="מלח+פלפל+כמון",wood="היקורי/אלון",coal="Fogo Premium",diff=4,sot=110,soh="6",somid="עטיפה ב-75°C",saved=4.0),
 ...
 dict(n=29,cat="חזיר",heb="פילה חזיר",eng="Pork Loin",kg=1.8,svt=60,svh="3-4",smt=110,smh="1",tgt=63,safe=63,sear="כן",mid="אין",wrap="לא",rest=15,rub="ראב מתוק+פפריקה",wood="דובדבן/תפוח",coal="Fogo Premium",diff=2,sot=120,soh="2.5",somid="מריחה",saved=1.5),
 dict(n=30,cat="חזיר",heb="פילה חזיר מדומה",eng="Pork Tenderloin",kg=0.5,svt=60,svh="2",smt=110,smh="0.5",tgt=63,safe=63,sear="כן",mid="אין",wrap="לא",rest=10,rub="חרדל+ראב",wood="תפוח",coal="Weber Lump",diff=1,sot=120,soh="1.5",somid="הפיכה",saved=1.0),
 ...
 dict(n=33,cat="חזיר",heb="קוטלט חזיר",eng="Pork Chops",kg=0.4,svt=60,svh="1-2",smt=110,smh="0.33",tgt=63,safe=63,sear="כן",mid="אין",wrap="לא",rest=8,rub="מלח+פלפל+מרווה",wood="תפוח",coal="Weber Lump",diff=2,sot=120,soh="1",somid="הפיכה",saved=0.7),
 ...
 dict(n=35,cat="טלה",heb="ירך טלה",eng="Leg of Lamb",kg=2.5,svt=56,svh="6-8",smt=110,smh="1.5",tgt=60,safe=63,sear="כן",mid="צינון",wrap="לא",rest=20,rub="שום+רוזמרין+מלח",wood="דובדבן/פקאן",coal="Fogo Super Premium",diff=3,sot=120,soh="3.5",somid="אין",saved=2.0),
 dict(n=36,cat="טלה",heb="צלעות כבש (קארה)",eng="Rack of Lamb",kg=0.7,svt=56,svh="2-3",smt=100,smh="0.5",tgt=56,safe=63,sear="כן",mid="אין",wrap="לא",rest=10,rub="חרדל+עשבי תיבול",wood="תפוח/דובדבן",coal="Kamado Joe",diff=3,sot=120,soh="1",somid="הפיכה",saved=0.5),
 ...
 dict(n=41,cat="עוף",heb="חזה עוף",eng="Chicken Breast",kg=0.4,svt=63,svh="1-2",smt=120,smh="0.33",tgt=68,safe=74,sear="לא",mid="אין",wrap="לא",rest=8,rub="ראב עדין+לימון",wood="דובדבן/תפוח",coal="Fogo Premium",diff=2,sot=120,soh="1",somid="מריחה",saved=0.7),
 ...
 dict(n=55,cat="בקר",heb="שפיץ צ'אך",eng="Rump Roast",kg=2.0,svt=56,svh="8",smt=110,smh="0.75",tgt=57,safe=63,sear="כן",mid="צינון",wrap="לא",rest=15,rub="מלח גס+פלפל",wood="דובדבן/אלון",coal="Fogo Premium",diff=2,sot=120,soh="3",somid="אין",saved=2.3),
 dict(n=56,cat="בקר",heb="זנב שור",eng="Oxtail",kg=1.5,svt=75,svh="24",smt=110,smh="2",tgt=95,safe=63,sear="לא",mid="אין",wrap="לא",rest=20,rub="ראב בקר",wood="אלון/היקורי",coal="Fogo Super Premium",diff=4,sot=110,soh="6",somid="עטיפה ב-75°C",saved=4.0),
 dict(n=57,cat="בקר",heb="עצמות מח עצם",eng="Beef Marrow Bones",kg=1.0,svt=64,svh="1",smt=110,smh="0.5",tgt=65,safe=63,sear="לא",mid="אין",wrap="לא",rest=5,rub="מלח גס",wood="אלון",coal="Weber Lump",diff=2,sot=120,soh="1.5",somid="אין",saved=1.0),
 ...
 dict(n=60,cat="טלה",heb="מותן טלה",eng="Lamb Loin",kg=1.0,svt=56,svh="2-3",smt=100,smh="0.5",tgt=56,safe=63,sear="כן",mid="אין",wrap="לא",rest=10,rub="שום+רוזמרין+מלח",wood="דובדבן",coal="Kamado Joe",diff=2,sot=120,soh="2",somid="הפיכה",saved=1.5),
 ...
 dict(n=91,cat="ירקות",heb="סלק",eng="Beets",kg=0.3,svt=85,svh="1.5",smt=180,smh="0.5",tgt=85,safe=0,sear="סו-ויד",mid="שמן+מלח",wrap="לא",rest=5,rub="שמן זית+תפוז+עזים",wood="דובדבן",coal="Weber Lump",diff=2,sot=180,soh="0.5",somid="קוביות ½-1 אינץ׳",saved=0.5),
 ...
 dict(n=101,cat="ירקות",heb="ארטישוק",eng="Artichoke",kg=0.4,svt=85,svh="0.75",smt=200,smh="0.15",tgt=85,safe=0,sear="הרתחה/אידוי→גריל",mid="בלאנץ׳ 25 דק׳",wrap="לא",rest=3,rub="שמן+שום+לימון+פטרוזיליה",wood="אלון/תפוח",coal="Weber Lump",diff=3,sot=100,soh="0.75",somid="חצוי, חתך כלפי מטה",saved=0.6),
 dict(n=102,cat="ירקות",heb="שום שלם מעושן",eng="Whole Smoked Garlic",kg=0.1,svt=85,svh="0.5",smt=100,smh="1",tgt=85,safe=0,sear="עישון",mid="אין",wrap="עטוף בנייר כסף",rest=5,rub="שמן זית+מלח",wood="תפוח/דובדבן",coal="Weber Lump",diff=1,sot=100,soh="1",somid="עד רך וזהוב, ממרח מדהים",saved=0.5),
 ...
 dict(n=113,cat="פירות ים",heb="שרימפס ג'מבו",eng="Jumbo Shrimp",kg=0.5,svt=0,svh="0",smt=230,smh="0.1",tgt=63,safe=63,sear="גריל ישיר",mid="אין",wrap="לא",rest=2,rub="שום+חמאה+לימון/פפריקה",wood="תפוח/אלון",coal="Weber Lump",diff=1,sot=230,soh="0.1",somid="על שיפוד, 1-2 דק'/צד",saved=0.42,doneness={'default': 'med', 'levels': {'mr': {'c': 52}, 'med': {'c': 60}, 'well': {'c': 66}}}),
 dict(n=114,cat="פירות ים",heb="שרימפס טייגר",eng="Black Tiger Shrimp",kg=0.5,svt=0,svh="0",smt=230,smh="0.1",tgt=63,safe=63,sear="גריל ישיר",mid="אין",wrap="לא",rest=2,rub="צ'ילי+שום+כוסברה",wood="תפוח/אלון",coal="Weber Lump",diff=1,sot=230,soh="0.1",somid="בקליפה לעסיסיות",saved=0.42,doneness={'default': 'med', 'levels': {'mr': {'c': 52}, 'med': {'c': 60}, 'well': {'c': 66}}}),
 dict(n=115,cat="פירות ים",heb="גמברי / חסילון ענק",eng="Giant Prawns",kg=0.6,svt=0,svh="0",smt=230,smh="0.12",tgt=63,safe=63,sear="גריל ישיר",mid="אין",wrap="לא",rest=2,rub="שמן זית+שום+פטרוזיליה",wood="תפוח/אלון",coal="Weber Lump",diff=2,sot=230,soh="0.12",somid="חצוי לאורך, בשר-למטה",saved=0.51,doneness={'default': 'med', 'levels': {'mr': {'c': 52}, 'med': {'c': 60}, 'well': {'c': 66}}}),
 dict(n=116,cat="פירות ים",heb="סקלופס",eng="Sea Scallops",kg=0.4,svt=0,svh="0",smt=240,smh="0.08",tgt=54,safe=63,sear="צריבה",mid="אין",wrap="לא",rest=1,rub="מלח+חמאה חומה",wood="תפוח/אלון",coal="Weber Lump",diff=2,sot=240,soh="0.08",somid="יבשים! 2-3 דק'/צד, אל תזיז",saved=0.34,doneness={'default': 'mr', 'levels': {'rare': {'c': 49}, 'mr': {'c': 52}, 'med': {'c': 57}, 'well': {'c': 63}}}),
 dict(n=117,cat="פירות ים",heb="זנב לובסטר",eng="Lobster Tail",kg=0.5,svt=0,svh="0",smt=230,smh="0.17",tgt=60,safe=63,sear="גריל בשר-למטה",mid="אין",wrap="לא",rest=3,rub="חמאת שום+לימון",wood="תפוח/אלון",coal="Weber Lump",diff=2,sot=230,soh="0.17",somid="חצוי, בשר-למטה 5 דק' ואז קליפה-למטה",saved=0.42,doneness={'default': 'med', 'levels': {'mr': {'c': 52}, 'med': {'c': 60}, 'well': {'c': 66}}}),
 dict(n=118,cat="פירות ים",heb="לובסטר שלם",eng="Whole Lobster",kg=0.7,svt=0,svh="0",smt=220,smh="0.2",tgt=60,safe=63,sear="גריל/הרתחה",mid="אין",wrap="לא",rest=3,rub="חמאה+עשבי תיבול",wood="תפוח/אלון",coal="Weber Lump",diff=3,sot=220,soh="0.2",somid="חצוי לאורך; מוכן כשאדום ואטום",saved=0.59,doneness={'default': 'med', 'levels': {'mr': {'c': 52}, 'med': {'c': 60}, 'well': {'c': 66}}}),
 dict(n=119,cat="פירות ים",heb="לנגוסטין",eng="Langoustine",kg=0.4,svt=0,svh="0",smt=230,smh="0.1",tgt=60,safe=63,sear="גריל ישיר",mid="אין",wrap="לא",rest=2,rub="שמן זית+שום+צ'ילי",wood="תפוח/אלון",coal="Weber Lump",diff=3,sot=230,soh="0.1",somid="חצוי, גריל מהיר",saved=0.34,doneness={'default': 'med', 'levels': {'mr': {'c': 52}, 'med': {'c': 60}, 'well': {'c': 66}}}),
 ...
 dict(n=123,cat="פירות ים",heb="תמנון",eng="Octopus",kg=1.0,svt=0,svh="0",smt=240,smh="0.17",tgt=75,safe=63,sear="הרתחה→גריל",mid="אין",wrap="לא",rest=3,rub="שמן זית+לימון+אורגנו",wood="אלון/גפן",coal="Kamado Joe",diff=4,sot=240,soh="0.17",somid="בשל 45-60 דק' לריכוך ואז חריכה",saved=0.85,doneness={'default': 'well', 'levels': {'med': {'c': 71}, 'well': {'c': 77}}}),
 dict(n=124,cat="פירות ים",heb="קלמרי / דיונון",eng="Squid / Calamari",kg=0.5,svt=0,svh="0",smt=250,smh="0.05",tgt=63,safe=63,sear="גריל חזק ומהיר",mid="אין",wrap="לא",rest=1,rub="שמן זית+שום+לימון",wood="תפוח/אלון",coal="Weber Lump",diff=2,sot=250,soh="0.05",somid="30-60 שנ'/צד — יותר=גומי",saved=0.42,doneness={'default': 'med', 'levels': {'med': {'c': 60}, 'well': {'c': 66}}}),
 dict(n=125,cat="פירות ים",heb="סטייק טונה",eng="Tuna Steak",kg=0.4,svt=0,svh="0",smt=250,smh="0.05",tgt=45,safe=63,sear="צריבה MR",mid="אין",wrap="לא",rest=1,rub="שומשום+סויה+ג'ינג'ר",wood="תפוח/אלון",coal="Weber Lump",diff=2,sot=250,soh="0.05",somid="סושי-גרייד; מרכז נא, 1-2 דק'/צד",saved=0.34,doneness={'default': 'med', 'scale': 'fish', 'levels': {'mr': {'c': 42}, 'med': {'c': 48}, 'well': {'c': 54}}}),
 dict(n=126,cat="פירות ים",heb="דג חרב",eng="Swordfish Steak",kg=0.5,svt=0,svh="0",smt=230,smh="0.1",tgt=60,safe=63,sear="גריל ישיר",mid="אין",wrap="לא",rest=2,rub="שמן זית+לימון+אורגנו",wood="תפוח/אלון",coal="Weber Lump",diff=2,sot=230,soh="0.1",somid="סטייק מוצק, קרוסהאץ'",saved=0.42,doneness={'default': 'med', 'scale': 'fish', 'levels': {'mr': {'c': 52}, 'med': {'c': 58}, 'well': {'c': 64}}}),
 dict(n=127,cat="פירות ים",heb="הליבוט",eng="Halibut",kg=0.5,svt=0,svh="0",smt=210,smh="0.12",tgt=58,safe=63,sear="גריל/צלייה",mid="אין",wrap="לא",rest=3,rub="חמאה+עשבי תיבול",wood="תפוח/אלון",coal="Weber Lump",diff=2,sot=210,soh="0.12",somid="לבן ומוצק — עדין, לא לייבש",saved=0.42,doneness={'default': 'med', 'scale': 'fish', 'levels': {'mr': {'c': 52}, 'med': {'c': 56}, 'well': {'c': 60}}}),
...
SPECIALS = [
 ...
 dict(n=2,cat="בשר מיובש",heb="ג'רקי הודו",eng="Turkey Jerky",cure="מרינדה דלת שומן",smt=70,smh="4-5",tgt="74°C ואז יבש",age="—",wood="תפוח/דובדבן",diff=2,note="להקפיד על 74°C לבטיחות לפני ייבוש."),
 ...
 dict(n=44,cat="גבינה",heb="פיור די לטה מעושן",eng="Smoked Fior di Latte",cure="ייבוש לילה במקרר, לחדר לפני",smt=28,smh="1-1.5",tgt="—",age="מיידי-קצר",wood="אלון/תפוח",diff=2,note="מוצרלת חלב פרה; עישון קצר בטמפ' נמוכה."),
