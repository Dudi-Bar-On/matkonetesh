...
WHATS_NEW = "מה חדש: התאמת מתכונים לציוד — פריט שהציוד שלך לא מספיק לו מסומן עם 'למה' ו'איך לתקן'; תזכורת לרישום מדחום; ושלוש שפות חדשות — צרפתית, גרמנית, ספרדית"
...
<footer>
  <div class="footnote">מתכונת · מדריך האש — נבנה מהטבלאות של דודי. סימוני ה-checklist והנתונים שלך נשמרים בדפדפן.<br><b class="foot-stamp" style="color:var(--ember2)">מהדורה 266 · 26.7.26</b><br><span class="foot-news">__WHATS_NEW__</span></div>
</footer>
