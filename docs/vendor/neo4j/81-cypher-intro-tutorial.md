---
name: 81-cypher-intro-tutorial
description: "Neo4j dev — Cypher introduction tutorial (59/60, getting-started)"
type: reference
---

<!-- source: https://github.com/neo4j/docs-getting-started/blob/dev/modules/ROOT/pages/cypher/intro-tutorial.adoc -->
<!-- source (raw): https://raw.githubusercontent.com/neo4j/docs-getting-started/dev/modules/ROOT/pages/cypher/intro-tutorial.adoc -->
