---
name: 80-what-is-a-graph-database
description: "Neo4j dev — What is a graph database (58/60, getting-started)"
type: reference
---

<!-- source: https://github.com/neo4j/docs-getting-started/blob/dev/modules/ROOT/pages/get-started-with-neo4j/graph-database.adoc -->
<!-- source (raw): https://raw.githubusercontent.com/neo4j/docs-getting-started/dev/modules/ROOT/pages/get-started-with-neo4j/graph-database.adoc -->
<!-- repo: neo4j/docs-getting-started  ref: dev -->
