---
name: 82-data-modeling-tutorial
description: "Neo4j dev — Data modeling tutorial (60/60, getting-started)"
type: reference
---

<!-- source: https://github.com/neo4j/docs-getting-started/blob/dev/modules/ROOT/pages/data-modeling/tutorial-data-modeling.adoc -->
<!-- source (raw): https://raw.githubusercontent.com/neo4j/docs-getting-started/dev/modules/ROOT/pages/data-modeling/tutorial-data-modeling.adoc -->
