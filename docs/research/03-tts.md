...
> **🧑 פסק בעלים 31.7.2026 — עדכון למסמך הזה:** **‏Google TTS מספיק טוב ונשאר ברירת המחדל היחידה. שכבת פרימיום בתשלום (ElevenLabs) — בוטלה: "לא מעוניין בפרמיום המאד יקר, זה לא כלכלי".** לכן דירוג ה-Tier S כאן הוא **מידע מחקרי בלבד ואינו מסלול מוצר**. שיפור ההגייה העברית מושג במקום זאת דרך **Phonikud** (ניקוד לפני הסינתזה, R-28) — שיפור איכות בעלות אפסית במקום החלפת ספק יקרה.
